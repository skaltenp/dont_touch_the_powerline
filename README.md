...
Some contexts that are generated by the comparably small chunks of max 512 tokens (sometimes even smaller), are useless and the evaluation model is useless. 
This can be adressed by incorporating better models in the ongoing work on this project.

![Some Limitations: Evaluation Bias](images/results_hist_plot.png)
Sometimes the evaluation is biased or false. This will be adressed in future work of our research in progress. 
